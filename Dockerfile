...
ADD imports/bin/setup /usr/local/bin/setup/1519586846
ADD imports/bin/config /usr/local/bin/config/1519586846
ADD imports/templates/init.sql /usr/local/templates/init.sql


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519586846 1>/dev/stdout 2>/dev/stderr
